...
// export const ContractAPI = {
//   getContracts: async (filters: ContractFilters = {}): Promise<GetContractsResponse> =>
//     unwrap(await api.get('/contracts', { params: filters })),

//   getContractById: async (id: string) =>
//     id ? unwrap(await api.get(`/contracts/${id}/show`)) : null,

//   createContract: (payload: CreateContractPayload) =>
//     api.post('/contracts/create', payload),

//   updateContract: (id: string, payload: UpdateContractPayload) =>
//     api.post(`/contracts/${id}/update`, payload),

//   toggleContractStatus: (id: string) =>
//     api.patch(`/contracts/${id}/toggle-active`),

//   deleteContract: (id: string) =>
//     api.delete(`/contracts/${id}/delete`),

//   getContractDates: async (contractId: string) =>
//     contractId ? unwrap(await api.get(`/contract-dates/${contractId}`)) : [],

//   getContractDateById: async (id: string) =>
//     id ? unwrap(await api.get(`/contract-dates/${id}/show`)) : null,

//   createContractDate: (payload: any) =>
//     api.post('/contract-dates/create', payload),

//   updateContractDate: (id: string, payload: UpdateContractDatePayload) =>
//     api.post(`/contract-dates/${id}/update`, payload),

//   deleteContractDate: (id: string) =>
//     api.delete(`/contract-dates/${id}/delete`),

//   getMealTimeWindows: async (id: string) =>
//     id ? unwrap(await api.get(`/meal-time-windows/${id}`)) : [],

//   getMeals: async (id: string) =>
//     id ? unwrap(await api.get(`/meals/${id}`)) : [],

//   createMeal: (payload: any) =>
//     api.post('/meals/create', payload),

//   updateMeal: (id: string, payload: UpdateMealPayload) =>
//     api.post(`/meals/${id}/update`, payload),
