...
export const FormSubmissionStepper = () => {
  const { t, i18n } = useTranslation();
  const isRTL = i18n.language === "ar";
  
  const { currentStep, setCurrentStep } = useFormRunner();
  
  const STEPS = [
    { id: 1, label: t('formSubmissions.contextSelection') },
    { id: 2, label: t('formSubmissions.forms') },
